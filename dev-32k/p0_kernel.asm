...
IFDEF FAT16
	EXTERN	IBOOTCODE		; Start of bootsector code in P1 main
ENDIF
...
I02A2:  DEFW    C0CFB,C03A8,C03B6,C042E,C043D,C0441,C03D4,C03FE	; 0
	...
	DEFW    C0D39,C0D93					; 67 Format, Ramdisk
...
; Inputs  C = character flags (b0 set, suppress upcasing, b1 set 1st double byte character, 
;         b2 set 2nd double byte character, b3 set volume name)
...
; Inputs  B  = flag (b0 reset do not real read, b1 reset ignore not recommended)
...
J3063:  LD      B,1
	...
	JR      Z,J30B9
IFDEF FAT16
; Get bootsector code from disk rom
	CALL	SDOSON
	LD      HL,IBOOTCODE
	LD      DE,ISB6F2
	LD      BC,0099H
...
CLST_2:	DB	0FDh,0CBh,20h,0DEh	;SET  3,(IY+20h)
	JR	CHK_C
